...
wget http://php.net/distributions/php-5.6.8.tar.bz2
...
echo "<html><meta charset='utf-8'><h1>おめでとうございます</h1><h4>Apache + PHP Works!</h4><h4>by kurotokiya</h4></html>" > /home/wwwroot/default/index.html
